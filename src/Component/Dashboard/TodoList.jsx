            ...
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                ...
                <div className="flex justify-between items-center mt-2">
                  ...
                  <div
                    className={`badge bg-green-300 text-black`}
                  >
                    {item.status}
                  </div>
                </div>
                <div className="mt-4">
                  <span className="text-gray-500">Deadline:</span> {item.deadline}
                  <button
          ...
          <div className="modal-box bg-white p-8 rounded-md shadow-md max-w-md mx-auto">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-4">
                ...
                <select {...register("priority", { required: true })} className="form-select w-full px-4 py-2 border rounded-md">
